...
export function DashboardOverview({ accounts , transactions } : DashboardOverviewProps) {
  ...
  const recentTransactions = (accountTransactions as any[])
  .slice() // optional: prevents mutation of original array
  .sort((a: any, b: any) => {
  ...
  const expensesByCategory = currentMonthExpenses.reduce((acc:any, transaction:any) => {
